...
githubRepositoryName='boston-toy-reusable'

applicationRegistrationDetails=$(az ad app create --display-name 'boston-toy-reusable')
...
resourceGroupResourceId=$(az group create --name BostonToyReusable --location westus3 --query id --output tsv)
